...
import getCalloutResponseContents from '@salesforce/apex/ServiceCUNextCallout.getCalloutResponseContents';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { CloseActionScreenEvent} from 'lightning/actions';

export default class ServiceCUNextCallout extends LightningElement {
    @api spinner=false;
    @api recordId;
    @api acctNo;
    ...
    connectedCallback() {
        ...
        console.log('id is heree ->  ' + this.recordId);
            ...
            .then(result => {
                   ...
                   if(result === 'Success'){
                    ...
                    this._title = 'Success';
                    this.message = 'Service CU Next Callout Synced Successfully!'
